...
| [`multi-agyw`](https://github.com/athowes/multi-agyw) |Estimating HIV risk group proportions using a multinomial spatio-temporal model ([`multi.utils`](https://github.com/athowes/multi.utils), [UNAIDS tool](https://hivtools.unaids.org/pse/))
